...
import { Account, Animal, Department, Entity } from 'src/models/dataModels';
...
function make_filter_page_data(
  ...
  find_data.name = getPropertyCode(find_data.name);
  console.log(find_data, getPropertyCode(find_data.name));
...
export { make_elements_page_meta_data, make_filter_page_data };
