...
import { getAuthState } from 'src/ts/Authorization';
import { deleteDataById } from 'src/api/deleteData';
...
export default defineComponent({
  ...
  methods: {
    onAdd() {
      var url = `/add/${this.child_name}/new`;
    ...
    onDelete(id: string) {
      var error = ref(new MyError(null, null));
      deleteDataById(this.name, id, error);
  ...
  setup() {
    ...
    console.log('find_options', find_options, child_name.value);
